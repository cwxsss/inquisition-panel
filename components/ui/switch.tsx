...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-primary data-[state=checked]:border-primary data-[state=unchecked]:bg-input data-[state=unchecked]:border-gray-300 dark:data-[state=unchecked]:border-gray-600",
      className
    )}
    {...props}
    ref={ref}
